...
function Submit($sub_type, $db, $table_name)
{
	if ($sub_type == 'sub_new') {
		...
		if (10000000 < $_FILES['fileToUpload']['size']) {
			echo '<div class="alert alert-danger" id="success-alert1"><h4><i class="icon fa fa-image"></i>Sorry, your file is too large.</h4></div>';
			$gtg = 0;
		}

		if ($check = false) {
			echo '<div class="alert alert-danger" id="success-alert"><h4><i class="icon fa fa-image"></i>Sorry, only OVPN files are allowed.</h4></div>';
			$gtg = 0;
		}
...
if (isset($_GET['create'])) {
	...
	echo "\r\n" . '        <div class="col-md-12 mx-auto">' . "\r\n" . '            <div class="card-body">' . "\r\n" . '                <div class="card bg-primary text-white">' . "\r\n" . '                    <div class="card-header card-header-warning">' . "\r\n" . '                        <center>' . "\r\n" . '                            <h2><i class="icon fa fa-image"></i> ADVERT\'s</h2>' . "\r\n" . '                        </center>' . "\r\n" . '                    </div>' . "\r\n\r\n" . '                    <div class="card-body">' . "\r\n" . '                        <div class="col-12">' . "\r\n" . '                        ' . "\t" . '<center>' . "\r\n\t" . '        ' . "\t\t\t\t\t" . '<a id="button" href="./';
	echo $base_file;
