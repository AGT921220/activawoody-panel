...
if ($config_ini['notes'] == 1) {
	echo '<a class="list-group-item list-group-item-action " href="note.php">' . "\r\n\t\t" . '<i class="fa fa-commenting" ></i>&nbsp;&nbsp;' . "\t" . 'Notifications </a>';
}

if ($config_ini['messages'] == 1) {
	echo '<a class="list-group-item list-group-item-action " href="message.php">' . "\r\n\t\t" . '<i class="fa fa-bullhorn" ></i>&nbsp;&nbsp;' . "\t" . 'In-app Messages </a>';
}

if ($config_ini['vpn'] == 1) {
	echo '<a class="list-group-item list-group-item-action " href="vpn.php">' . "\r\n\t\t" . '<i class="fa fa-user-secret" ></i>&nbsp;&nbsp;' . "\t" . 'OVPN Settings </a>';
}
