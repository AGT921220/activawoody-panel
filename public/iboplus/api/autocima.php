...
<head>
    ...
    <style>
        body {
            ...
            align-items: flex-end; /* Alinhado na parte inferior */
            min-height: 100vh;
        ...
        .movie-container {
            ...
            align-items: center;
            padding-right: 20px; /* Espaço para o balão */
        }
        .movie-banner {
            display: flex;
        ...
        .subtitial-info {
            font-size: 1.5vw;
            bottom: -105vw; /* Posicionado na parte inferior */
            max-width: 300px; /* Largura máxima do balão */
            padding: 20px;
            background-color: rgba(0, 0, 0, 0.7);
            border-radius: 10px;
            text-align: left;
            position: relative;
            margin-right: -700px; /* Espaço entre o balão e o cartaz do filme */
        }
        .subtitial-info::before {
            content: '';
            position: absolute;
            top: 50%;
            right: -200px; /* Posição do balão */
