...
<?php
						...
						echo '<div class="ctradio"><input type="radio" name="upload-type" id="upload-radio" checked> Set Logo Using File &nbsp&nbsp</div>';
                        echo '<div class="ctradio"><input type="radio" name="upload-type" id="url-radio"> Set Logo Using URL </div>';
