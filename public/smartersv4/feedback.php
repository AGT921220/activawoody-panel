...
if (isset($_GET['delete'])) {
    ...
    echo "<script type='text/javascript'>
              window.location.href='feedback.php?status=3';
            </script>";
}

if (isset($_GET['delete_all'])) {
    $db1->exec('DELETE FROM rtxfeedback');
    // header('Location: feedback.php');
...
<main role="main" class="col-15 pt-4 px-5 ctpadd-0">
    <div class="">
            ...
            <div class="card border-left-primary shadow h-100 card shadow mb-4 ctcard">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center mt-1">
                        <a id="button" href="?delete_all" class="btn btn-danger">Delete All</a>
                    </div>
                </div>
