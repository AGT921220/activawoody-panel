        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mx-md-auto">
					...
					<br>
                 <center><a class="list-grup-item" href="https://t.me/apkrebrandec/" target="_blank">&nbsp&nbsp&nbsp&nbsp&#169  <?=date("Y")?> * REBRAN ECUADOR* </a></center>
                </div>
            </div>
        </div>
<br><br>
